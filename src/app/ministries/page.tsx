    ...
    <div className="bg-background">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center">
          <h1 className="font-headline text-4xl font-bold tracking-tight text-primary md:text-5xl">Our Ministries</h1>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {ministries.map((ministry) => {
            ...
            return (
              <Card key={ministry.id} className="group overflow-hidden shadow-lg transition-shadow duration-300 hover:shadow-2xl">
                <div className="relative h-60 w-full overflow-hidden">
                  {ministryImage && (
                   ...
                   <div className="absolute bottom-0 left-0 p-6">
                      <h3 className="font-headline text-3xl font-bold text-white">{ministry.name}</h3>
                   </div>
                </div>
